...
_subscription_id = os.popen('az ad signed-in-user show --query id -o tsv').read().replace('\n', '')
_oea_version = "0.7"
...
_include_groups = True if (len(sys.argv) > 3 or sys.argv[3] in ['true', 'True']) else False
