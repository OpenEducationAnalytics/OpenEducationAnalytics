> **Note:** This package is currently released as v1.1 rc1, and is dependent on the OEA framework v0.8
...
`cd clouddrive`\
`wget https://github.com/microsoft/OpenEduAnalytics/releases/download/package_Learning_Analytics_v1.1_rc1/package_Learning_Analytics_v1.1_rc1.zip`\
`unzip ./package_Learning_Analytics_v1.1_rc1.zip`
...
`./package_Learning_Analytics_v1.1_rc1/setup.sh mysynapseworkspacename`) to install this package into your own environment.
