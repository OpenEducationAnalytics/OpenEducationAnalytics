...
#  - setup Datasets
eval "az synapse dataset create --workspace-name $synapse_workspace --name DS_ADLS_binary_file --file @$this_file_path/synapse/dataset/DS_ADLS_binary_file.json"
eval "az synapse dataset create --workspace-name $synapse_workspace --name DS_ADLS_binary_folder --file @$this_file_path/synapse/dataset/DS_ADLS_binary_folder.json"
...
eval "az synapse dataset create --workspace-name $synapse_workspace --name DS_ADLS_parquet --file @$this_file_path/synapse/dataset/DS_ADLS_parquet.json"
...
# 2) install notebooks
eval "az synapse notebook import --workspace-name $synapse_workspace --name OEA_py --spark-pool-name spark3p1sm --file @$this_file_path/synapse/notebook/OEA_py.ipynb --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name 1_read_me --spark-pool-name spark3p1sm --file @$this_file_path/synapse/notebook/1_read_me.ipynb --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name 2_batch_processing_demo --spark-pool-name spark3p1sm --file @$this_file_path/synapse/notebook/2_batch_processing_demo.ipynb --only-show-errors"
