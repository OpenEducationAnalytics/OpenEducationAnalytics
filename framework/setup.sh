...
eval "az synapse notebook import --workspace-name $synapse_workspace --name ContosoSIS_py --spark-pool-name spark3p1sm --file @$this_file_path/../modules/Student\ and\ School\ Data\ Systems/notebook/ContosoSIS_py.ipynb --only-show-errors"
