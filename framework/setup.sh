...
#az synapse dataset create --workspace-name $synapse_workspace --name data_lake_binary --file @$this_file_path/dataset/data_lake_binary.json
#az synapse dataset create --workspace-name $synapse_workspace --name data_lake_csv --file @$this_file_path/dataset/data_lake_csv.json
