...
az storage container create --account-name $storage_account --name test-data --auth-mode login
...
testdata_id="/subscriptions/$subscription_id/resourceGroups/$resource_group/providers/Microsoft.Storage/storageAccounts/$storage_account/blobServices/default/containers/test-data"
