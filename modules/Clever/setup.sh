...
sed "s/storage_account = '.*'/storage_account = '$OEA_STORAGE_ACCOUNT'/" $this_file_path/notebooks/Clever_setup_and_update.ipynb > $this_file_path/../../tmp/Clever_setup_and_update.ipynb
