...
# 1) install notebooks
eval "az synapse notebook import --workspace-name $synapse_workspace --name SIF_example --spark-pool-name spark3p2med --file @$this_file_path/notebook/SIF_example.ipynb --only-show-errors"
