...
# 3) install notebooks
eval "az synapse notebook import --workspace-name $synapse_workspace --name Refine_EdFi --spark-pool-name spark3p2med --file @$this_file_path/notebook/Refine_EdFi.ipynb --only-show-errors"
