...
eval "az synapse notebook import --workspace-name $synapse_workspace --name EdFi_Refine --spark-pool-name spark3p2sm --file @$this_file_path/notebook/EdFi_Refine.ipynb --only-show-errors"
