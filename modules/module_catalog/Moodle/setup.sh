...
# 1) install notebooks
eval "az synapse notebook import --workspace-name $synapse_workspace --name Moodle_example --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Moodle_example.ipynb --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name Moodle_ingest --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Moodle_ingest.ipynb --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name Moodle_refine --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Moodle_refine.ipynb --only-show-errors"
