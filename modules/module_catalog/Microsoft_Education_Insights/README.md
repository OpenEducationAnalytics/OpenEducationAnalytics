> **Note:** This module is currently released as v0.2rc1, and is dependent on the OEA framework v0.8rc1
...
`cd clouddrive`\
`wget https://github.com/microsoft/OpenEduAnalytics/releases/download/v0.2rc1/module_Microsoft_Education_Insights_v0.2rc1.zip`\
`unzip ./module_Microsoft_Education_Insights_v0.2rc1.zip`
...
`./module_Microsoft_Education_Insights_v0.2rc1/setup.sh mysynapseworkspacename`) to install this package into your own environment.
