...
eval "az synapse notebook import --workspace-name $synapse_workspace --name Insights_DataValidation --spark-pool-name spark3p2med --file @$this_file_path/notebook/Insights_DataValidation.ipynb --only-show-errors"
