...
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 1_land_insights --file @$this_file_path/pipeline/1_land_insights_prod_data.json"
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 1_land_insights --file @$this_file_path/pipeline/1_land_insights_test_data.json"
