...
eval "az synapse notebook import --workspace-name $synapse_workspace --name Graph_OEA_Connector --spark-pool-name spark3p2med --file @$this_file_path/notebook/Graph_OEA_Connector.ipynb --only-show-errors"
