...
sed "s/storage_account = '.*'/storage_account = '$storage_account'/" $this_file_path/notebooks/iReady_setup_and_update.ipynb > $this_file_path/../../tmp/iReady_setup_and_update.ipynb
