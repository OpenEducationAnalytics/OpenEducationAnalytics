...
if [ $# -ne 1 ] && [ $# -ne 2 ] && [ $# -ne 3 ]; then
    ...
    echo "    setup.sh <myprefix>"
    echo "where myprefix is a prefix representing your organization (eg, CISD3). This value must be 12 characters or less (consider using an abbreviation) and must contain only letters and/or numbers."
    echo ""
    ...
    echo "    setup.sh <myprefix> <location>"
    echo "where myprefix is a prefix for your organization (eg, CISD3), and location is the abbreviation of the desired location (eg, eastus, westus, northeurope)."
    echo ""
    ...
    echo "    setup.sh <myprefix> <location> true"
    echo "where myprefix is a prefix for your organization (eg, CISD3), and location is the abbreviation of the desired location (eg, eastus, westus, northeurope), and true specifies that security groups should be created."
    exit 1
fi
